<?php
  ...
  if(!empty($_SESSION['admin_id'])) {
    ...
    $result = mysqli_query($conn,"SELECT * FROM `car_rental`;");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">Rental Vehicle</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Pricing</a></li>
                <li class="breadcrumb-item active" aria-current="page">Rent a Cab</li>
              </ol>
            </nav>
          </div>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-dark">
                    ...
                    <tbody>
                    <tr>
                            <td><?php echo $row['car_rental_id']; ?> </td>
                            <td><?php echo $row['car_rental_name']; ?> </td>
                            <td><?php echo $row['cars_available']; ?> </td>
                            <td><?php echo $row['total_cars']; ?> </td> <!--itinearay id-->
                            <td><?php echo $row['price']; ?> </td> <!--itinearay id-->
                            <td>
